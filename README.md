...
十五座競技場，全部以 `LevelBuilder` 撰寫而成。前五座是本作原創的場地；
後十座則向 1999 年原作中最為人稱道的經典地圖致敬——**佈局與節奏取自記憶中的原版，
幾何則完全重新打造**，沒有沿用任何原作檔案。

| `--map` | 名稱 | 致敬對象 | 特色 |
| --- | --- | --- | --- |
| 0 | DM-深淵甲板 | — | 懸空平台與跳台，掉下去就沒了 |
| 1 | DM-鏽蝕高塔 | — | 多層塔樓，垂直纏鬥 |
| 2 | DM-熔岩神殿 | — | 熔岩池環繞的神殿中庭 |
| 3 | DM-軌道競技場 | — | 環形軌道站，四面通透 |
| 4 | CTF-雙子要塞 | — | 對稱雙堡，經典奪旗節奏 |
| 5 | CTF-對峙世界 | *Facing Worlds* | 兩座小行星塔樓、螺旋坡道，中央狹橋上放著救世主 |
| 6 | DM-摩菲斯之塔 | *Morpheus* | 三棟摩天樓頂，**低重力**，欄杆缺口正對鄰塔 |
| 7 | DM-超載星艦 | *HyperBlast* | 對稱星艦內艙，上層天橋貫穿全船 |
| 8 | DM-哥德庭園 | *Gothic* | 紫夜、列柱、火盆與發光祭壇 |
| 9 | DM-渦輪機房 | *Turbine* | 工業廠房，圍繞巨型渦輪的環廊 |
| 10 | CTF-熔岩巨人 | *Lava Giant* | 熔岩海中的紅藍雙堡，中央山脊是必爭之地 |
| 11 | DM-詛咒之庭 | *Curse* | 緊湊的石室與地下通道 |
| 12 | DM-古籍密室 | *Codex* | 環形迴廊包夾中央豎井，書牆環繞 |
| 13 | DM-火衛基地 | *Phobos* | 火衛星表面基地，**低重力** |
| 14 | DM-磚牆競技場 | *Stalwart* | 磚砌大廳、看台走道與兩側側室 |

低重力關卡由 `Level.GravityScale` 控制；跳台的彈道解算與電腦對手的投射物提前量都會據此調整，
因此在摩菲斯之塔上助跑起跳確實可以飛到隔壁棟。

競技場圖庫中的每張卡片都有專屬的預覽插圖與介紹，滑鼠移過即可查看。
...
* **武器** — 十一把全部以程式建模，統一以 -Z 為前方的區域座標系，因此同一份網格可同時用於
  第一人稱視角、第三人稱持槍與道具展示台。
* **競技場** — 十五座場地全部透過 `LevelBuilder` 撰寫，同時產生算圖幾何與碰撞筆刷。圓形結構
...
所有名稱、角色與資源皆為原創。本專案是同類型遊戲的獨立實作，並非移植，不含原作的任何素材。

其中十座競技場的佈局向 1999 年原作的經典地圖致敬，但幾何、材質與道具配置都是重新設計並
以程式產生的——沒有反編譯、轉檔或複製任何原作關卡資料。
